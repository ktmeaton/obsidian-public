...
% Simple Title Page of Just the Short Title
\def\shorttitlep{
	\thispagestyle{empty}
	\null\vfill
	\begin{center}
		\LARGE \uppercase\expandafter{$shorttitle$}
	\end{center}
	\vfill
...
\def\titlep{
	...
	\begin{center}
		\rm\uppercase{By}\\
		\uppercase\expandafter{$author$, $prevdegree$}\\
...
% Table of Contents, List of Figures, List of Tables, Notations
\referencepages
