...
% \Crefname{section}{Chapter}{Sections}
...
\null\vskip1in
\begin{center}
	\large\uppercase\expandafter{$title$: $subtitle$}
\end{center}
\vfill
\begin{center}
	\rm\uppercase{By}\\
	\uppercase\expandafter{$author$, $prev-degree-short$}\\
...
\begin{center}
	\large
	\copyright\ Copyright\ by $author$, $copyright_year$\\
		All Rights Reserved
\end{center}
\vskip.5in
\newpage
...
% Signature Page
\noindent
$degree$ ($copyright_year$) \hfill  McMaster University \\
($department$)                                \hfill  Hamilton, Ontario, Canada


\vspace{1in}
\noindent
\begin{tabular}{ll}
TITLE:           & \parbox[t]{4in}{$title$: $subtitle$} \\ \\
AUTHOR:          & \parbox[t]{4in}{$author$ \\ $prev-degree-full$} \\ \\
SUPERVISOR:      & \parbox[t]{4in}{$supervisor$} \\ \\
...
\chead{Ph.D. Thesis - $author$; McMaster University - $department$.}
