...
![A subset of the 100+ metadata columns retrieved for *P. aeruginosa* sequencing projects.  Viewed with DB Browser for SQLite (https://sqlitebrowser.org/).](https://rawcdn.githack.com/ktmeaton/NCBImeta/ae039b348f433/paper/figures/NCBImeta_aeruginosa_db_subset.png){#fig:NCBImeta_aeruginos_db_subset short-caption="A subset of the 100+ metadata columns retrieved for *P. aeruginosa* sequencing projects."}
