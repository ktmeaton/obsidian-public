...
First, as a control, we examined _Y. pestis_ populations that have <u>no temporal signal</u>. These "negative" cases inform us about the minimum sampling time, or phylodynamic threshold, required to obtain robust temporal estimates in _Y. pestis_. Second, we examined populations that have temporal signal, but which produced <u>conflicting dates</u> at internal nodes, such as the time to most recent common ancestor (tMRCA). We explore how <u>sampling bias</u> drives this outcome in many cases, which has led to irreproducible estimates between studies. Third, we identify the populations with the most reliable temporal estimates. We discuss how these molecular dates have changed our understanding of pandemic "origins" and complements historical scholarship. Finally, we discuss how these results inform <u>phylogeographic</u> analysis such as estimating ancestral location and migrations.

1. Short-Term, Episodic Epidemics
2. Irreproducible dates.
...
The phylodynamic threshold has been rigorously explored in other pathogens [@duchene2020TemporalSignalPhylodynamic], but not explicitly in _Y. pestis_. Researchers have anecdotally mentioned the challenges in reconstructing intra-epidemic plague diversity. For example, several isolates from the Second Pandemic dated to the medieval [[Black Death]] (1346-1353) are indistinguishable clones [@spyrou2016HistoricalPestisGenomes], extinguishing any hope of reconstructing its spread from genetic evidence alone. Our median rate estimation for the Second Pandemic (1.PRE) of 1 substitution every 9.5 years (2.5  x 10<sup>-8</sup> subs/site/year) is congruent with this finding. The clonal nature of the Black Death is not an exceptional event, but rather the norm based on the sampling time frame. Our results highlight a significance limitation and cautionary note for plague research, as genetic evidence is not suitable for reconstructing the timing and spread of short-term, episodic epidemics.

Similar to the Second Pandemic, the timing of plague's re-emergence during the Third Pandemic remains enigmatic. Prior to the dispersal of _Y. pestis_ out of Hong Kong in 1894, highly localized epidemics began appearing in Yunnan, China [@xu2014WetClimateTransportation; @xu2019HistoricalGenomicData]. Unfortunately, the ancestral _Intermedium_ (1.IN) population has no detectable temporal signal and thus the available genetic evidence does not further our understanding of the _timing_ of these precursor events. However, the _location_ of these events can be inferred with much greater confidence, as _Intermedium_ (1.IN) has strong geographic structure. To reconstruct ancestral locations, we fit discrete migration models to the maximum-likelihood phylogeny [@sagulenko2018TreeTimeMaximumlikelihoodPhylodynamic] at three geographic levels: (1) continent, (2) country, and (3) province. We estimate that the Third Pandemic (1.ORI) diverged from a rodent reservoir located in Yunnan, China  (Figure @fig:divtree_1.IN_province). 
The specificity (province) and strength (likelihood: 1.0) of this estimate are only possible because genomic data from non-human samples are available. Without which there would be little geographic structure, leading to poor likelihoods, and no representative data from Yunnan, resulting in the ancestral location shifting elsewhere.

ampled location_

However, there remains a long internal branch that connects 1.IN and 1.ORI, thus this geographic estimate reflects the <u>last sampled location</u>...

A key avenue for future research will therefore be to expand the sampling time frame and diversity of _Intermedium_ (1.IN) in order to test whether temporal signal can be recovered. If possible, this will contribute a new line of evidence to the discourse surrounding the epidemiology of the Third Pandemic [@benedict1988BubonicPlagueNineteenthCentury] and the driving factors behind this re-emergence.



![Geographic structure of the _Intermedium_ (1.IN) population. Branches are colored based on a discrete, ancestral state reconstruction using sampling location (province). Branch labels indicate the likelihood of the ancestral location given the data.](https://raw.githubusercontent.com/ktmeaton/plague-phylogeography-projects/2045cdb/main/auspice/all/chromosome/full/filter5/ml/divtree_1.IN_province.png){#fig:divtree_1.IN_province width=60%}

#### Irreproducible Dates
...
Recovering robust temporal signal in the Third Pandemic population 

**Historical Background:**
	- 1770-1870 | 100 years | Localized plague outbreaks in China
	- 1894-1901 | 5 years | Global spread.


|    Region     |   Appearance    | Status  | Genomes | Introductions |
|:-------------:|:---------------:|:-------:|:-------:|:-------------:|
|   Australia   | Novel Emergence | Extinct |    0    |       ?       |
|    Europe     |  Re-Emergence   | Extinct |    0    |       ?       |
|               |                 |         |         |               |
| North America | Novel Emergence | Endemic |   19    |       ?        |
| South America | Novel Emergence | Endemic |   67    |       ?       | 
|    Africa     |  Re-emergence   | Endemic |    5    |       ?       |
|     Asia      |  Re-emergence   | Endemic |   24    |       ?       |
 
1. **We know nothing about _Y. pestis_ in Europe and Australia!**
	- How are we supposed to make inferences about the past?
1. **North America is unique, in having only a single introduction.**
2. **South America: Independent Introductions to same country!**
3. **Asia and Africa: Reintroduced to different countries.**

What can or cannot say about the Third Pandemic?
1. Geographic origin: China (100%), Yunnan Province (99%)
	- Why such confidence?
	- Intensive sampling of non-human _Y. pestis_ 
1. A single global radiation (polytomy)
2. Single introduction (North America)
	- Formation of new reservoirs (California, New Mexico)
3. Multiple introductions (South America)
	- Formation of new reservoirs
	- Only known because of sampling non-human rodents.
- Europe (no endemic reservoir, no cases after 1950)
