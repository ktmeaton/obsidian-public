...
To demonstrate the application of our molecular clock method and the interpretive consequences, we explored three outcomes as case studies. First, as a control, we examined _Y. pestis_ populations that had <u>[[Eaton et al. 2021 Plagued by a cryptic clock#i No Temporal Signal\|(i) no temporal signal]]</u>. These "negative" cases inform us about the minimum sampling time, or phylodynamic threshold, required to obtain robust temporal estimates in _Y. pestis_. Second, we examined populations with <u>[[Eaton et al. 2021 Plagued by a cryptic clock#ii Irreproducible Estimates\|(ii) irreproducible estimates]]</u> between studies, such as the time to most recent common ancestor (tMRCA). We discuss how sampling bias drives this outcome, and how it can be identified and corrected with ancient DNA calibrations. Finally, we identify the populations with the most <u>[[Eaton et al. 2021 Plagued by a cryptic clock#iii Informative Rates and Dates\|(iii) informative rates and dates]]</u>. We discuss how these molecular dates have changed our understanding of pandemic "origins" and complement historical scholarship.
