...
- Methodological considerations of molecular clock analyses of zoonotic pathogens.
- Do I have anything new to say about the history and epidemiology of plague?
...
3. Bayesian Evaluation of Temporal Signal (BETS).
	- Strict Clock
	- Relaxed Clock
	- Global Clock: All samples
...
- For all populations, the relaxed clock outer-performed the strict clock.
